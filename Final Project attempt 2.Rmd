...
```{r}
FBI_year%>%
  ggplot(aes(x=year, y=`violent crime rate`))+
  geom_point()+
...
```{r}
FBI_year%>%
  ggplot(aes(x=year, y=`murder and nonnegligent manslaughter`))+
  geom_point()+
...
FBI_year%>%
  ggplot(aes(x=year, y=`aggravated assault`))+
  geom_point()+
...
FBI_year%>%
  ggplot(aes(x=year, y=`property crime`))+
  geom_point()+
...
FBI_year%>%
  ggplot(aes(x=year, y=`larceny-theft`))+
  geom_point()+
...
In order to figure out the best predictor of violent crimes I created a tree using the different types of crime. The best and only statistically significant predictor of violent crime was aggravated assault. 
